...
export function APIShareModelUsage({ instanceId, className }: { instanceId: string; className?: string }) {
  const groupResults = api.resourceLog.groupAPIShareLogsInDurationWindowByModel.useQuery({
    instanceId,
    durationWindow: "7d",
  });
